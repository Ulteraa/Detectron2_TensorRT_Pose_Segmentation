...
def get_sample_inputs(args):
    ...
    if args.sample_image is None:
        ...
        # )
        aug = T.ResizeShortestEdge ( [1344, 1344], 1344)
...
if __name__ == "__main__":
    ...
    args.config_file = 'mask_rcnn_swint_T_FPN_3x.yaml'

    cfg.merge_from_file("mask_rcnn_swint_T_FPN_3x.yaml")  # Replace with your model's config file
